...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.borda.setStyleSheet(u"*{background-color: #fff} #borda {border-radius:5px; border: 2px solid #3A4B5E}")
        ...
        "QDialogButtonBox *[text=\"&Yes\"]{background-color: #3A4B5E; color: #fff}\n"
        "QPushButton:hover{font-weight: 600; border-width: 2px}\n"
        "QPushButton{width: 155px; height:32px; border-radius:16px; border: 1px solid #3A4B5E; margin-left: 16px; margin-right: 16px; font-size: 18px;font-weight: 450}")
...
class Ui_Dialog_2(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setStyleSheet(u"QDialogButtonBox *[text=\"OK\"]{background-color: #3A4B5E; color: #fff}\n"
        "QPushButton:hover{font-weight: 600; border-width: 2px}\n"
        "QPushButton{width: 155px; height:32px; border-radius:16px; border: 1px solid #3A4B5E; margin-left: 16px; margin-right: 16px; font-size: 18px;font-weight: 450}")
