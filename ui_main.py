...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u'''QScrollBar:vertical {border-radius: 8px;} QScrollBar::handle:vertical:hover {background: #B6B9BC;}
        QScrollBar::handle:vertical {border-radius: 7px;margin: 1px;background: #c6c8ca;} QScrollBar::add-line:vertical {height: 0px;subcontrol-position: bottom;subcontrol-origin: margin;}
        QScrollBar::sub-line:vertical {height: 0px;subcontrol-position: top;subcontrol-origin: margin;}QScrollBar::add-page:vertical, QScrollBar::sub-page:vertical {background: none;}
        
        QScrollBar:horizontal {border-radius: 8px;} QScrollBar::handle:horizontal:hover {background: #B6B9BC;}
        QScrollBar::handle:horizontal {border-radius: 7px;margin: 1px;background: #c6c8ca;} QScrollBar::add-line:horizontal {height: 0px;subcontrol-position: bottom;subcontrol-origin: margin;}
        QScrollBar::sub-line:horizontal {height: 0px;subcontrol-position: top;subcontrol-origin: margin;}QScrollBar::add-page:horizontal, QScrollBar::sub-page:horizontal {background: none;}''')
...
"QPushButton{color:#fff;}")
        ...
        self.main_membros.setStyleSheet(u"background-color: #fff; border-radius:15px;")
        ...
        self.searchbox.setStyleSheet(u"QFrame#searchbox{border-radius: 19px; border-width: 1px; border-style: solid; border-color: #c4c4c4; padding-left:16px}")
        ...
        self.lineEdit_busca_membro = QLineEdit(self.searchbox)
        ...
        self.tableWidget_membros.setStyleSheet(u"QTableView{color: #3A4B5E;}")
        self.tableWidget_membros.setFocusPolicy(Qt.ClickFocus)
        self.tableWidget_membros.horizontalHeader().setStyleSheet(u"QHeaderView::Section:first{padding-left: 62px} QHeaderView::Section{background-color: #fff; border:hidden}")
        ...
        self.tableWidget_membros.setShowGrid(True)
        self.tableWidget_membros.setGridStyle(Qt.SolidLine)
        ...
        self.main_historico.setStyleSheet(u"background-color: #fff; border-radius:15px;")
        ...
        self.verticalLayout_62.setContentsMargins(40, 0, 40, 0)
        ...
        self.tableWidget_historico.horizontalHeader().setStyleSheet(u"QHeaderView::Section{background-color:#fff; border:hidden}")
        ...
        self.tableWidget_historico.setStyleSheet(u"QTableView{color:#3A4B5E}")
        ...
        self.tableWidget_historico.setShowGrid(True)
        self.tableWidget_historico.setGridStyle(Qt.SolidLine)
...
"QLineEdit{border-radius: 22px; border-width: 1px; border-style: solid; border-color: #c4c4c4; padding-left:16px}")
        ...
        self.lineEdit_financ_data_inicio = QLineEdit(self.frame_50)
        ...
        self.lineEdit_financ_data_inicio.setStyleSheet(u"QLineEdit:hover{border-color: #28A745}\n"
"QLineEdit:focus{border-color: #28A745}\n"
"QLineEdit{border-radius: 22px; border-width: 1px; border-style: solid; border-color: #c4c4c4; padding-left:16px}")

        ######################################################
        self.lineEdit_financ_data_inicio.setValidator(self.validaData)
        self.lineEdit_financ_data_inicio.setMaxLength(10)
        self.lineEdit_financ_data_inicio.setInputMethodHints(Qt.ImhDate)
        ########################################################
        ...
        self.lineEdit_financ_data_fim = QLineEdit(self.frame_53)
        ...
        self.lineEdit_financ_data_fim.setStyleSheet(u"QLineEdit:hover{border-color: #28A745}\n"
"QLineEdit:focus{border-color: #28A745}\n"
"QLineEdit{border-radius: 22px; border-width: 1px; border-style: solid; border-color: #c4c4c4; padding-left:16px}")

        ######################################################
        self.lineEdit_financ_data_fim.setValidator(self.validaData)
        self.lineEdit_financ_data_fim.setMaxLength(10)
        self.lineEdit_financ_data_fim.setInputMethodHints(Qt.ImhDate)
        ########################################################
...
"QPushButton{color:#5F7A99; border-radius: 16px; border-width: 1px; border-style: solid; border-color: #5F7A99;}")
        ...
        self.horizontalLayout_36.setContentsMargins(24, 0, 24, 48)
...
"QPushButton{background-color: #fff; color: #AE4547;  border-radius: 22px; border: 2px solid #AE4547}")
        ...
        self.main_lista_entrada.setStyleSheet(u"background-color: #fff; border-radius:15px;")
...
QComboBox{padding-left:8px; color: #848484; border-radius: 12px; border-width: 1px; border-style: solid; border-color:#c4c4c4;}''')
        ...
        self.tableWidget_lista_entrada.setFocusPolicy(Qt.StrongFocus)
        self.tableWidget_lista_entrada.setStyleSheet(u"QHeaderView::Section{color:#3A4B5E; text-decoration: underline;} QTableView{color:#3A4B5E}")
        self.tableWidget_lista_entrada.setEditTriggers(QAbstractItemView.SelectedClicked)
        self.tableWidget_lista_entrada.setAlternatingRowColors(True)
        self.tableWidget_lista_entrada.setShowGrid(True)
        self.tableWidget_lista_entrada.setGridStyle(Qt.SolidLine)
        ...
        self.main_lista_saida.setStyleSheet(u"background-color: #fff; border-radius:15px;")
...
QComboBox{padding-left:8px; color: #848484; border-radius: 12px; border-width: 1px; border-style: solid; border-color:#c4c4c4;}''')
        ...
        self.tableWidget_lista_saida.setFocusPolicy(Qt.StrongFocus)
        self.tableWidget_lista_saida.setStyleSheet(u"QHeaderView::Section{color:#3A4B5E; text-decoration: underline;} QTableView{color:#3A4B5E}")
        self.tableWidget_lista_saida.setEditTriggers(QAbstractItemView.SelectedClicked)
        self.tableWidget_lista_saida.setAlternatingRowColors(True)
        self.tableWidget_lista_saida.setShowGrid(True)
        self.tableWidget_lista_saida.setGridStyle(Qt.SolidLine)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_financ_data_inicio.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Data Inicio", None))
        self.label_aviso_financ_data_fim.setText("")
        self.lineEdit_financ_data_fim.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Data Fim", None))
